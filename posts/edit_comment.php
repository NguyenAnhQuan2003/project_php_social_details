...
<head>
    ...
    <title>Sửa Bình Luận - QQ Social</title>
...
<body>
    ...
    <div class="edit-container">
        ...
        <div class="edit-card">
            <h2 class="mb-4">
                <i class="bi bi-pencil-square me-2"></i>Sửa Bình Luận
            </h2>
            ...
            <form method="POST">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="content" name="content" rows="6" required><?php echo htmlspecialchars($comment['content']); ?></textarea>
                </div>
